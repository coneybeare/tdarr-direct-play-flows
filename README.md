...
### [Flow 01 — Direct Play Optimizer](flows/01_hevc_mp4_direct_play.json)
...
Generated by `scripts/layout_flows.py`. Node colors indicate plugin type (see legend). Green edges = yes/success, red = no/failure, gray = error path.
