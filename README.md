...
Generated by `scripts/layout_flows.py`. Node colors indicate plugin type (see legend in each image). Green edges = yes/success, red = no/failure, gray = error path.

### Flow 01 — Direct Play Optimizer

![Flow 01 Architecture](images/01_hevc_mp4_direct_play.svg)

### Flow 02 — Audio Fix: Stereo AAC 2.0 + EAC3 5.1

![Flow 02 Architecture](images/02_audio_stereo_add_only.svg)

### Flow 03 — HDR-Aware Transcode

![Flow 03 Architecture](images/03_hdr_aware_transcode.svg)
